...
**Daily-maximum mode (daily_max=True)**:
    ...
    in Step 3b threshold calibration, where Hₛ is also represented as a
...
def build_tide_cache(
    ...
    daily_max : bool, optional
        ...
        consistent with the GLORYS12 daily snapshot convention (Step 2 and sub-step 3a).
        If True, FES2022 is evaluated at hourly resolution and the daily
        maximum tide height is retained — intended for Step 3b threshold
