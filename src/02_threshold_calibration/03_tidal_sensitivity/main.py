"""
Entry point for the tidal sensitivity analysis (OSR11 — Step 2c).

This analysis extends the preliminary compound event occurrence analysis
(Step 2b) by adding FES2022 astronomical tide to the GLORYS12 SSH signal.

Usage
-----
Run from project root::

    python src/02_threshold_calibration/03_tidal_sensitivity/main.py --all

Individual parts::

    python src/02_threshold_calibration/03_tidal_sensitivity/main.py --event-figures
    python src/02_threshold_calibration/03_tidal_sensitivity/main.py --summary
