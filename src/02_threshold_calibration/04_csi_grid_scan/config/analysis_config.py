"""
Configuration for the CSI Grid Scan (Step 2d).

Part of STEP 2 — Threshold Calibration (umbrella step).
Location: src/02_threshold_calibration/04_csi_grid_scan/

This sub-step performs a systematic CSI grid scan over pairs of Hₛ and SSH_total
...
decision consolidated in the Tidal Sensitivity Analysis (Step 2c).
...
Domain: Full Santa Catarina coast — same 5 sectors and 91 events as Steps 2a–2c.
"""
...
# Project root: config/ -> 04_csi_grid_scan/ -> 02_threshold_calibration/ -> src/ -> root
