...
**Directory:** `src/02_threshold_calibration/`
...
> **Note on imports:** This directory is registered as `src.threshold_calibration` via
> a compatibility alias in `src/__init__.py`. All existing `from src.threshold_calibration.xxx import`
