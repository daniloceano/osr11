"""
Entry point for the south SC test data exploratory analysis (OSR11 — Step 2a).
...
Run individual parts::
    ...
    python src/02_threshold_calibration/01_exploratory_data_analysis/main.py --maps
    python src/02_threshold_calibration/01_exploratory_data_analysis/main.py --timeseries
    python src/02_threshold_calibration/01_exploratory_data_analysis/main.py --reported-events
    python src/02_threshold_calibration/01_exploratory_data_analysis/main.py --municipalities
    python src/02_threshold_calibration/01_exploratory_data_analysis/main.py --sector-boxplots
    python src/02_threshold_calibration/01_exploratory_data_analysis/main.py --statistics
    python src/02_threshold_calibration/01_exploratory_data_analysis/main.py --write-readmes
...
from src.exploratory_data_analysis.boxplots import run_sector_figures
from src.exploratory_data_analysis.config.analysis_config import CFG
from src.exploratory_data_analysis.io import (
    load_glorys_data,
    load_reported_events,
    load_wave_data,
)
from src.exploratory_data_analysis.maps import run_spatial_analysis
from src.exploratory_data_analysis.metadata import write_data_readmes
from src.exploratory_data_analysis.municipalities import run_municipality_grid_association
from src.exploratory_data_analysis.reported_events import run_reported_events_eda
from src.exploratory_data_analysis.statistics import run_additional_analyses
from src.exploratory_data_analysis.timeseries import run_timeseries_analysis
from src.exploratory_data_analysis.utils import make_output_dirs
