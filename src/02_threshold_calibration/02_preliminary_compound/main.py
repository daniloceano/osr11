"""
Entry point for the preliminary compound event occurrence analysis (OSR11 — Step 2b).
...
Run from project root::
    ...
    python src/02_threshold_calibration/02_preliminary_compound/main.py --all
...
Individual parts::
    ...
    python src/02_threshold_calibration/02_preliminary_compound/main.py --event-figures
    python src/02_threshold_calibration/02_preliminary_compound/main.py --summary
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Preliminary compound event occurrence analysis — OSR11 Step 2b",
