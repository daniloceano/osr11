# Step 2b — Preliminary Compound Event Occurrence Analysis: Quick-Start Guide
...
- MagicA must be installed from GitHub (not on PyPI):
  ...
  ```
- The physical directory is `src/02_threshold_calibration/02_preliminary_compound/` but it is registered as
