"""
Central configuration for the Preliminary Compound Event Occurrence Analysis (Step 2b).

Part of STEP 2 — Threshold Calibration (umbrella step).
Location: src/02_threshold_calibration/02_preliminary_compound/
...
# Project root: config/ -> 02_preliminary_compound/ -> 02_threshold_calibration/ -> src/ -> root
