...
subsequent analysis steps (Step 3a tidal sensitivity, Step 3b threshold calibration),
...
# Identical to _SOUTH_SC_COORDS in src/02_threshold_calibration/02_preliminary_compound/events.py.
