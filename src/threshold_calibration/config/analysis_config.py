"""
Central configuration for the threshold calibration analysis.
...
# Project root: config/ -> threshold_calibration/ -> src/ -> root
ROOT = Path(__file__).resolve().parents[3]

CFG: dict = {
    # ── Input data paths ──────────────────────────────────────────────────────
    # Unified daily dataset: VHM0, VMDR, zos all on the WAVERYS spatial grid
    "unified_file": ROOT / "data/test/metocean_sc_sul_unified_waverys_grid.nc",
    ...
    # ── Analysis parameters ───────────────────────────────────────────────────
    # Restrict to South sector to match test domain extent
    "target_sector": "South",
    ...
    # Quantile for initial threshold calibration
