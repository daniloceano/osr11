...
export const metadata = {
  title: 'Tidal Sensitivity Analysis — Step 2c — OSR11',
  description:
        ...
        <div className="border-b border-gray-200 bg-white py-16">
          <div className="mx-auto max-w-5xl px-6">
            <div className="mb-4 flex items-center gap-2 text-xs text-gray-500">
              ...
              <span className="text-gray-600">Tidal Sensitivity</span>
            </div>
        ...
        <div className="border-b border-gray-200 bg-white py-14">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <p className="mb-6 text-sm text-gray-600 max-w-2xl">
              ...
              The chart reflects the physically correct daily-maximum tide convention.
            </p>
          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-5">
              ...
              <ul className="space-y-1.5">
                {[
                  'For the formal threshold calibration (Step 2d — CSI grid scan), SSH_total = zos(00:00 UTC) + FES2022 tide(daily max) is used, consistent with this sensitivity analysis. This is now the canonical SSH_total definition across the pipeline.',
                  'The daily-max tide convention is shared by both Step 2c and Step 2d. Any future step that computes SSH_total should use the same daily-maximum tide from FES2022 evaluated at hourly resolution.',
