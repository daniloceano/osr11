...
export const metadata = {
  title: 'Threshold Calibration — CSI Grid Scan (Step 4b) — OSR11',
  description:
          ...
          <div className="mx-auto max-w-5xl px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <p className="text-sm text-gray-700 leading-relaxed">
                ...
                as a conventional starting point to build the methodology infrastructure. Step 4b asks
                ...
                <br /><br />
                Step 4b asks: <strong>which pair of (Hₛ, SSH_total) thresholds best separates the
              ...
              <p className="text-sm text-gray-700 leading-relaxed">
                ...
                <br /><br />
                The calibrated threshold pair from Step 4b directly informs Step 5 (Storm Catalog
        ...
        <div className="border-b border-gray-200 bg-gray-50 py-14">
          <div className="mx-auto max-w-5xl px-6">
            ...
            <p className="mb-6 text-sm text-gray-600 max-w-3xl">
              This is the central methodological decision of Step 4b. An observed event reported on civil
            ...
            <div className="rounded-xl border border-gray-200 bg-white overflow-hidden shadow-sm">
              ...
              <div className="border-t border-gray-100 px-5 py-4">
                <p className="text-xs text-gray-500 italic leading-relaxed">
                  ...
                  coverage in red. Lines indicate the municipality→grid association used throughout Step 4b.
