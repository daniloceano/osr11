...
export const methodologySteps: MethodStep[] = [
  ...
  },
  {
    ...
    description:
      ...
      + 'Three sub-steps: 3a (Tidal Sensitivity) and 3b (CSI Grid Scan) are complete; '
      + '3c (False Alarm Attribution) is planned. '
    ...
    subSteps: [
      ...
      },
      {
        ...
        description:
          'Cross-reference the 1 298 flagged episodes with S2ID, Atlas Digital, and media archives to reclassify genuine under-reported events and revise effective CSI before advancing to Step 4.',
        status: 'planned',
      },
    ],
  },
  ...
  },
  {
    ...
    description:
      'Identify compound events as temporal overlaps between independent sea-level and wave storms from the Step 4 catalogs. Compute co-occurrence statistics: frequency, intensity, duration, peak time lags, and seasonal distribution.',
    status: 'planned',
    stepNumber: 5,
  },
  {
...
established from the Step 3 CSI grid scan against the 91-event Leal et al. (2024) SC
