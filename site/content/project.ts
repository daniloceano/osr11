...
export const projectMeta = {
  ...
  statusLabel: 'Hazard Characterization, Population Exposure and Municipal Risk Integration Complete',
  dataRange: '1993–2025',
...
export const timelinePhases: TimelinePhase[] = [
  ...
  },
  {
    ...
    description: 'Umbrella calibration step with five sub-steps — all complete. Steps 2a–2d established SSH_total, swept 81 threshold pairs, and diagnostically selected q90/q90. Step 2e was recalibrated on 2026-07-30 to score the production detector (Hₛ and tide-free zos percentiles, gated by max(SWL) > HAT) instead of SSH_total, over an extended 11×11 grid that adds q95 and q99. The sweep showed the previous composite score had no interior optimum — it preferred, monotonically, to detect nothing — so the burden term was rebuilt as a two-sided deviation from an expected detection rate anchored on Leal et al. (2024), the weights moved to 0.30/0.60/0.10 and the confidence alphas to 0.20/0.50/0.30. Selected pair: q70/q99, with the same recall as q90/q90 and 62% fewer unmatched detections.',
    status: 'done',
    stepNumber: 2,
    tasks: [],
    subSteps: [
