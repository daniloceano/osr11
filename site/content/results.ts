...
export const resultCards: ResultCard[] = [
  {
    ...
    outputs: [
      ...
      '2d: Optimal pair q90/q90 (H=21, M=70, F=1 298, CSI=0.0151, diagnostic)',
      ...
      '2e: Independent confirmation q90/q90 (R_pos=0.268, B_target_effective = 324 ep/yr)',
      '2e: Sensitivity analyses (weights, B_target, city source audit)',
