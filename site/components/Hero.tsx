    ...
    <section className="relative overflow-hidden border-b border-gray-200 bg-gradient-to-b from-gray-50 to-white pt-24 pb-20">
      ...
      <div className="relative mx-auto max-w-5xl px-6">
        ...
        <p className="mb-8 max-w-3xl text-base leading-relaxed text-gray-600">
          Coastal communities and infrastructure along Brazil&apos;s South Atlantic Eastern Coast face compound coastal flooding—where meteorological tides (storm surges) coincide with extreme wave events. This project quantifies these joint hazards using CMEMS multiyear reanalyses (GLORYS12 and WAVERYS) across 808 coastal grid points (1993–2025), detecting events as the co-occurrence of a sea-level extreme and a local significant-wave-height exceedance, both defined by local percentiles rather than absolute values. Reported disaster records support threshold calibration. Hazard characterization is integrated with municipal-scale exposure spatialization and social vulnerability to produce compound coastal risk indices for adaptation planning.
        </p>
